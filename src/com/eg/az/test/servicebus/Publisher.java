...
public class Publisher extends TestCase {
	...
	//static String connectionString = "Endpoint=sb://sbkr001.servicebus.windows.net/;SharedAccessKeyName=tester;SharedAccessKey=ypp6gGdYFMZpfLhej9qlKdwE9UCGeiol0y34AEFsM/I=;EntityPath=q1";
	//static String queueName = "q1";
	
	//static String connectionString = "Endpoint=sb://sbkr001.servicebus.windows.net/;SharedAccessKeyName=tester1;SharedAccessKey=zXkys+67tC2zFU0apXTdFkJHFpNtqsuZsVSwtItQcHg=;EntityPath=q2";
	//static String queueName = "q2";
